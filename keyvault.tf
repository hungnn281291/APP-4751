...
module "key_vault" {
  source                 = "git::https://github.com/hungnn281291/Modules.git//terraform-azurerm-key-vault"
...
module "key_vault_secret_1" {
  source       = "git::https://github.com/hungnn281291/Modules.git//terraform-azurerm-key-vault-secret"
